...
Invoke-WebRequest -Uri "http://download.parallels.com/ras/v16/16.0.1.18458/RASInstaller-16.0.18458.msi" -OutFile "C:\Packages\Plugins\RASInstaller-16.0.18458.msi"
sleep -Seconds 3
