...
.DESCRIPTION  
    This script is part of the Parallels RAS auto-deploy script for AWS MarketPlace Deployments and Generate welcome message at first logon, and opens RAS Console
.NOTES  
    File Name  : RAS_AWS_MP_AIO_Login.ps1
    Author     : www.parallels.com
.EXAMPLE
    .\RAS_AWS_MP_AIO_Login.ps1
#>
