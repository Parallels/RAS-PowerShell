...
.DESCRIPTION  
    This script is part of the Parallels RAS auto-deploy script for Azure MarketPlace Deployments and performs the installation and configuration needed on the management server.
.NOTES  
