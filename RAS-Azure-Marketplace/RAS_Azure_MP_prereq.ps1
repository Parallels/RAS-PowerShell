...
.DESCRIPTION  
    This script is part of the Parallels RAS auto-deploy script for Azure MarketPlace Deployments and performs the installation and configuration of prerequisites for the Parallels RAS deployment.
.NOTES  
